...
namespace Leptonica
{
    public static class ClassApp
    {
        ...
        public static int pixGetWordsInTextlines(this Pix pixs, int minwidth, int minheight, int maxwidth, int maxheight, out Boxa pboxad, out Pixa ppixad, out Numa pnai)
        {
            if (null == pixs)
            {
            ...
            var result = Native.DllImports.pixGetWordsInTextlines((HandleRef)pixs, minwidth, minheight, maxwidth, maxheight, out pboxadPtr, out ppixadPtr, out pnaiPtr);
        ...
        /// ]]>
        public static int pixGetWordBoxesInTextlines(this Pix pixs, int minwidth, int minheight, int maxwidth, int maxheight, out Boxa pboxad, out Numa pnai)
        {
            if (null == pixs)
            {
                throw new ArgumentNullException("pixs cannot be null.");
            ...
            var result = Native.DllImports.pixGetWordBoxesInTextlines((HandleRef)pixs, minwidth, minheight, maxwidth, maxheight, out pboxadPtr, out pnaiPtr);
            pboxad = new Boxa(pboxadPtr);
            pnai = new Numa(pnaiPtr);
