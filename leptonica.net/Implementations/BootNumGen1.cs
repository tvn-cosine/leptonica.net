...
namespace Leptonica 
{
    public static class BootNumGen1
    {
        public static Pixa l_bootnum_gen1(IntPtr vo)
        {
            if (IntPtr.Zero == vo)
            {
                throw new ArgumentNullException("vo cannot be null");
            }

            var pointer = Native.DllImports.l_bootnum_gen1(vo);
            if (null == pointer)
            {
                return null;
            }
        ...
        /// Serialized string   
        /// </summary>
        public static string l_bootnum1 =
