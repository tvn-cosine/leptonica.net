...
namespace Leptonica 
{
    public static class BootNumGen2
    {
        public static Pixa l_bootnum_gen2(IntPtr vo)
        {
            if (IntPtr.Zero == vo)
            {
            ...
            var pointer = Native.DllImports.l_bootnum_gen2(vo);
            if (null == pointer)
            {
                return null;
            }
        ...
        /// Serialized string   
        /// </summary>
        public static string l_bootnum2 =
