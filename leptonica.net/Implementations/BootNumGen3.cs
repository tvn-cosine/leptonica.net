...
namespace Leptonica 
{
    public static class BootNumGen3
    { 
        public static Pixa l_bootnum_gen3(IntPtr vo)
        {
            if (IntPtr.Zero == vo)
            {
            ...
            var pointer = Native.DllImports.l_bootnum_gen3(vo);
            if (null == pointer)
            {
                return null;
            }
        ...
        /// Serialized string 
        /// </summary>
        public static string l_strdata_0 =
